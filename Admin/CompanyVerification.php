...
$selqry = "select * from tbl_company s inner join tbl_location l on s.company_location=l.location_id inner join tbl_place p on p.place_id=l.place_id inner join tbl_district d on d.district_id=p.district_id where company_status='0'"; 
...
?>
		<tr align="center">
           ...
           <img src="../Assets/File/company/<?php echo $row["company_proof"];?>" width="50" height="50" />
            ...
            <a href="companyVerification.php?ch=<?php echo $row["company_id"];?>">Accept</a>&nbsp;&nbsp;

            <a href="companyVerification.php?mh=<?php echo $row["company_id"];?>">Reject</a>
            </td>      
       	</tr>
        <?php
}
