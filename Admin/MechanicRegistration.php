...
if(isset($_POST["btnsubmit"]))
{
	...
	move_uploaded_file($temp,'../Assets/File/Workshop/'.$photo);
		...
		$insqry="insert into tbl_mechanic(mechanic_name,mechanic_contact,mechanic_email,mechanic_address,mechanic_password,mechanic_photo,mechanic_doj)values('".$name."','".$contact."','".$email."','".$address."','".$password."','".$photo."',curdate())";
