...
$selqry="select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_user u on u.user_id=b.user_id where company_id='".$_SESSION["sid"]."' and booking_status!=0 and cart_status!=0";
...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr align="center">
          ...
          <td><img src="../Assets/File/company/<?php echo $row["product_photo"];?>" width="100" height="100" /></td>
