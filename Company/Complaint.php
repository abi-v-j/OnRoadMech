...
if(isset($_POST["btnsave"]))
{
	...
	$complaint=$_POST["txtcomplaint"];
				...
				$insqry="insert into tbl_complaint(complainttype_id,complaint_content,complaint_date,company_id)values('".$complaint_type."','".$complaint."',curdate(),'".$_SESSION["sid"]."')";
...
$selqry = "select * from tbl_complaint c inner join tbl_complainttype t on c.complainttype_id=t.complainttype_id inner join tbl_company s on c.company_id=s.company_id  where c.company_id='".$_SESSION["sid"]."'";
