        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <br />
                    <h6 class="text-info"> Select Specification</h6>
                    <ul class="list-group">
                        <?php                           
						 $selbrand = "SELECT * from tbl_specification";
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="productCheck()" class="form-check-input product_check" id="brand" value="<?php echo $row["specification_id"]; ?>" ><?php echo $row["specification_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="productCheck()" class="form-check-input product_check" id="type" value="<?php echo $row["model_id"]; ?>" ><?php echo $row["model_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
