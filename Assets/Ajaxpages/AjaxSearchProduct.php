...
include("../Connection/Connection.php");
    ...
    if (isset($_GET["action"])) {
        ...
        $sqlQry = "select * from tbl_product t inner join tbl_subcategory s on s.subcategory_id=t.subcategory_id inner join tbl_specification y on y.specification_id=t.specification_id inner join tbl_model p on p.model_id=t.model_id inner join tbl_category c on c.category_id=s.category_id where true ";
        $row = "SELECT count(*) as count from tbl_product t inner join tbl_subcategory s on s.subcategory_id=t.subcategory_id inner join tbl_specification y on y.specification_id=t.specification_id inner join tbl_model p on p.model_id=t.model_id inner join tbl_category c on c.category_id=s.category_id where true ";
        ...
        if ($_GET["brand"]!=null) {
            ...
            $sqlQry = $sqlQry." AND y.specification_id IN(".$brand.")";
            $row = $row." AND y.specification_id IN(".$brand.")";
        }
	       ...
	       if ($_GET["type"]!=null) {
            ...
            $sqlQry = $sqlQry." AND p.model_id IN(".$type.")";
            $row = $row." AND p.model_id IN(".$type.")";
        }
		  // echo $sqlQry;
